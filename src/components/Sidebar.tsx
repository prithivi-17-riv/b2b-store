...
const NAV_ITEMS: NavItem[] = [
  ...
  { name: 'Customer Outstanding', href: '/outstanding', icon: AlertCircle, roles: ['ADMIN', 'SALES_EMPLOYEE'] },
  ...
  { name: 'Warehouses', href: '/warehouses', icon: Warehouse, roles: ['ADMIN', 'WAREHOUSE_STAFF'] },
  { name: 'Deliveries & Logistics', href: '/deliveries', icon: Truck, roles: ['ADMIN', 'DELIVERY_STAFF'] },
  { name: 'Returns & Credit Notes', href: '/returns', icon: RotateCcw, roles: ['ADMIN', 'WAREHOUSE_STAFF'] },
